...
- ⚠️ **مهم جدًا**: كرر نفس الخطوة لملف `supabase/fix-authenticated-read-access.sql` — ده
  بيصلح خطأ كان بيمنع أي مستخدم عادي (مسجل دخول بحساب مش أدمن) من رؤية أي محتوى في الموقع
  خالص. لازم يتشغل، وإلا أي حد يعمل حساب هيلاقي الموقع فاضي قدامه.
