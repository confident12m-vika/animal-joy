...
لحد ما تعملي الخطوات دي، الموقع بيشتغل عادي تمامًا **من غير أي إعلانات ظاهرة أو مربعات
فاضية** — الإعلانات بتتفعل تلقائيًا بس بعد ما تحطي بياناتك الحقيقية.

### 1. اطلبي الموافقة من Google AdSense
- روحي على [adsense.google.com](https://adsense.google.com) واعملي حساب.
- ضيفي دومينك: `animaljoystories.com`.
- Google هتطلب منك تضيفي كود التحقق بتاعها في الموقع — **مش محتاجة تعملي حاجة يدويًا**،
  لأن سكريبت AdSense هيتفعل تلقائيًا بمجرد ما تحطي الـ Publisher ID في الخطوة 3.
- المراجعة والموافقة بتاخد من أيام لحد أسابيع، وبتعتمد على وجود محتوى حقيقي كافي في الموقع
  (فيه معلومة مهمة: يفضل تكوني ضايفة شوية من المحتوى الحقيقي قبل ما تقدمي الطلب).

### 2. بعد الموافقة، خدي الـ Publisher ID بتاعك
- من داشبورد AdSense: **Account** → **Account information**.
- هيكون شكله: `ca-pub-1234567890123456`.
...
- محليًا: في ملف `.env`، ضيفي:
  ...
  ```
- على Vercel: **Settings** → **Environment Variables** → ضيفي نفس الاسم والقيمة → **Redeploy**.

### 4. حدّثي ملف `ads.txt`
- افتحي `public/ads.txt` في المشروع.
- استبدلي السطر التجريبي بالسطر الحقيقي اللي AdSense هتديهولك (شكله عادة):
  ```
  google.com, pub-1234567890123456, DIRECT, f08c47fec0942fa0
  ```
- ده ملف إجباري لـ AdSense، من غيره الإعلانات ممكن تترفض أو ميتحققش من الموقع.
...
بعد كده الإعلانات هتظهر تلقائيًا في الأماكن المحددة، من غير أي تعديل تاني في الكود.
